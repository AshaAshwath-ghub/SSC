"""
Script to create Asha users in the database.
- asha.ashwathappa@gmail.com (for Google OAuth)
- asha.ashwathappa@jillellagroup.com (for local login)
"""
import asyncio
import sys
...
async def create_asha_users():
    """Create Asha users in the database."""
    ...
    users = [
        {
            "email": "asha.ashwathappa@gmail.com",
            "username": "asha.ashwathappa",
            "password": None,  # OAuth user - no password needed
            "first_name": "Asha",
            "last_name": "Ashwathappa"
        },
        {
            "email": "asha.ashwathappa@jillellagroup.com",
            "username": "asha.ashwathappa.corp",
    ...
    try:
        ...
        print("-" * 60)
        print("Google OAuth:")
        print("  Email: asha.ashwathappa@gmail.com")
        print("-" * 60)
        print("Local Login:")
        print("  Email:    asha.ashwathappa@jillellagroup.com")
